public class SecurityPassMaker
{
    public string GetDisplayName(TeamSupport support)
    {
        ...
        {
            Physio physio => physio.Title,
            OffensiveCoach offensiveCoach => offensiveCoach.Title,
            GoalKeepingCoach goalKeepingCoach => goalKeepingCoach.Title,
            Security security => security switch
            {
                SecurityJunior junior => junior.Title,
                SecurityIntern intern => intern.Title,
                PoliceLiaison police => police.Title,
                _ => security.Title + " Priority Personnel",
            },
