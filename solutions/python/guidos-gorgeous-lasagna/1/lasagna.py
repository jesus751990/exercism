...
def preparation_time_in_minutes(number_of_layers):
    ...
    total preparation time based on the `PREPARATION_TIME` constant.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :param number_of_layers: int - number of layers in the lasagna.
    :param elapsed_bake_time: int - baking time already elapsed.
    :return: int - total elapsed time (in minutes) including preparation and baking time.

    Function that takes the number of layers and the elapsed baking time as
    arguments and returns the total elapsed time (in minutes) by adding
