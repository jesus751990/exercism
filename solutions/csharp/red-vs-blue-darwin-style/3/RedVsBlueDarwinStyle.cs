...
namespace Combined
{
    ...
    {
        public static Red.RemoteControlCar BuildRed() => new(new Red.Motor(), new Red.Chassis(), new Red.Telemetry(), new Red.RunningGear());

        public static Blue.RemoteControlCar BuildBlue() => new(new Blue.Motor(), new Blue.Chassis(), new Blue.Telemetry());
    }
}
