...
func Tally(reader io.Reader, writer io.Writer) error {
	...
	err := tournament.fromResults(reader)
	if err != nil {
		return err
	}
	...
	for _, team := range tournament.sort() {
...
func (t Tournament) getOrCreateTeam(n string) *Team {
	if t[n] == nil {
		t[n] = &Team{name: n}
	}
	return t[n]
...
func (t Tournament) fromResults(r io.Reader) error {
